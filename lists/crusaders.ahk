...
crusaders["emo"] := crusaders["sally"] := crusaders["karen"] := [2, 1]
crusaders["hermit"] := crusaders["kyle"] := crusaders["draco"] := crusaders["henry"] := [3, 1]
crusaders["princess"] := crusaders["turkey"] := crusaders["rayna"] := [4, 1]
crusaders["jason"] := crusaders["pete"] := crusaders["broot"] := crusaders["paul"] := [5, 1]
crusaders["khouri"] := crusaders["momma"] := crusaders["brogon"] := crusaders["halfbloodelf"] := [6, 1]
crusaders["sarah"] := crusaders["soldierette"] := crusaders["snickette"] := [7, 1]
...
crusaders["merci"] := crusaders["petra"] := crusaders["bat"] := [10, 1]
crusaders["exterminator"] := crusaders["gloria"] := [11, 1]
crusaders["greyskull"] := crusaders["eiralon"] := [12, 1]
crusaders["jim"] := crusaders["pam"] := crusaders["veronica"] := [1, 2]
crusaders["sasha"] := crusaders["groklok"] := crusaders["mindy"] := [2, 2]
...
crusaders["lion"] := crusaders["drizzle"] := crusaders["bubba"] := [5, 2]
...
crusaders["phoenix"] := crusaders["alan"] := crusaders["frightotron"] := [8, 2]  
