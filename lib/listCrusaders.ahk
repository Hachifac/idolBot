...
crusaders := Object()
crusaders["bush"] := [1, 1]
crusaders["rabbit"] := crusaders["graham"] := crusaders["warwick"] := crusaders["slisiblyp"] := [1, 1]
crusaders["emo"] := crusaders["sally"] := crusaders["karen"] := crusaders["turps"] := crusaders["roboqueen"] := [2, 1]
...
crusaders["sal"] := crusaders["wendy"] := crusaders["robbie"] := crusaders["val"] := crusaders["penny"] := [8, 1]
crusaders["reginald"] := crusaders["siri"] := crusaders["boggins"] := crusaders["squiggles"] := crusaders["beary"] := [9, 1] 
...
crusaders["chiyome"] := crusaders["griz"] := [crusaders["biff"] := 13,1]
crusaders["casey"] := crusaders["frankie"] := crusaders["thoonoose"] := [14,1]
crusaders["jim"] := crusaders["pam"] := crusaders["veronica"] := crusaders["arachnobuddy"] := crusaders["james"] := [1, 2]
crusaders["sasha"] := crusaders["groklok"] := crusaders["mindy"] := crusaders["danni"] := [2, 2]
crusaders["kaine"] := crusaders["monkey"] := crusaders["larry"] := crusaders["bernard"] := crusaders["zombiewinter"] := [3, 2]
...
crusaders["gryphon"] := crusaders["rocky"] := crusaders["montana"] := crusaders["darkhelper"] = crusaders["red"] := [6, 2]
...
crusaders["viktor"] := crusaders["shenna"] := crusaders["guardian"] := [13,2]
